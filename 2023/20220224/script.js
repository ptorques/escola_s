...
Cha.container = "chaleira"

Cha.servir = function() {
    console.log("O chá está na xícara");
    this.container = "xícara"
}
...
let pessoa1 = new Pessoa("Rigoberto Almeida", 17)
let pessoa2 = new Pessoa2("Joana Ceres", 32)
